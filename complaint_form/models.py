...
class Complaint(models.Model):
    ...
    secondary_first_name = models.CharField(max_length=128) # fillers first name
    secondary_last_name = models.CharField(max_length=128) # fillers last name

    secondary_email = models.EmailField() # fillers email address
    secondary_phone_number = PhoneNumberField() # fillers phonenumber
    secondary_address = models.CharField(max_length=128) # filler's home address
    secondary_city = models.CharField(max_length=64) # filler's home city
    ...
    secondary_zip_code = models.IntegerField() # the filler's home zip code
    ...
    discrimination_type = models.CharField(max_length=128, choices=DISCRIMINATION_TYPE_CHOICES) # the way in which the filler was treated unfairly
    discrimination_date = models.DateField() # the date the discrimination occured
    ...
    related_offender_name = models.CharField(max_length=200) #the party whose grievance or other action is related to this particular complaint
    date_filed = models.DateField() #the date that the related complaint was filed
    status_or_disposition = models.CharField(max_length=200) #the status or disposition of the related complaint
    date_of_disposition = models.DateField() #the date of the disposition of the related complaint
    date_of_act = models.DateField() #the date of the act of which the related complaint concerns
    ...
    date = models.DateField() #date of signature/form submission
